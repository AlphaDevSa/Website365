      ...
      <Section id="plans">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card
            ...
            ctaOnClick={() => openOrderModal({ title: 'Master Reseller 1', price: 'R395', yearlyPrice: 'R3705', billingPeriod: 'Monthly', category: 'Master Reseller Hosting' })}
            features={[
              "5 WHM accounts",
              "500 cPanel accounts",
              "100GB Disk Space",
          ...
          <Card
            ...
            ctaOnClick={() => openOrderModal({ title: 'Master Reseller 2', price: 'R495', yearlyPrice: 'R4675', billingPeriod: 'Monthly', category: 'Master Reseller Hosting' })}
            popular={true}
            features={[
              "10 WHM accounts",
        ...
        <div className="text-center text-sm text-slate-500 mt-12 bg-slate-50 border border-slate-100/60 rounded-2xl py-4 px-6 max-w-2xl mx-auto">
          Subject to <Link to="/fair-usage-policy" className="text-yellow-600 hover:text-yellow-500 font-semibold underline transition-colors">Fair Usage and Acceptable Usage Policy</Link>
        </div>
      </Section>
