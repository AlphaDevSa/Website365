...
import DomainResellerModal from '../src/components/DomainResellerModal.jsx';
...
describe('DomainResellerModal', () => {
  it('closes via the close button', async () => {
    const user = userEvent.setup();
    const onClose = vi.fn();

    render(<DomainResellerModal isOpen onClose={onClose} />);
  ...
  it('shows an error message on failed submission', async () => {
    ...
    render(<DomainResellerModal isOpen onClose={() => {}} />);
    ...
    await user.click(screen.getByRole('button', { name: /submit application/i }));
    await screen.findByText(/error submitting your application/i);
  });
});
